...
const monsters = {
  ...
  5: {
    ...
    hint: (
      <p>
        Такое ощущение, будто контуры монстра разделены на два канала... Кажется, Магитры Ордена Оптики носили специальные приспособления, которые помогали объединять такие каналы и поэтому они невосприимчивы к такой магии.
      </p>
    ),

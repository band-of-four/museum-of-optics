...
const monsters = {
  ...
  3: {
    name: 'Зеркальный', sprite: Specular,
  ...
  7: {
    ...
    hint: (
      <p>
        Ты слышал, что Орден Оптики хранит артефакт, способный освещать предметы без источников света. Звучит как что-то, что могло бы здорово выручить в твоём положении!
      </p>
    ),
